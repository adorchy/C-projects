...
int insListeVide (Liste * liste, char *donnee){
...
int insDebutListe (Liste * liste, char *donnee){
...
int insFinListe (Liste * liste, Element * courant, char *donnee){
...
int insListe (Liste * liste, char *donnee, int pos){
